...
<body>
	<div class="titulo">
		<h1 name="centro" value="2">Calendario de Reservas - Centro Deportivo B - CHIRIQUI</h1>
	</div>
	<hr>
	<div class="container">
		<div class="nav-main">
			<nav class="nav-main">
				<ul class="nav-menu">
					<li><button onclick="window.location.href = 'http://localhost/php2/index.php';" class="btn">Centro Deportivo A</button></li>
				</ul>
				<ul>
					<li><button onclick="window.location.href = 'http://localhost/php2/indexB.php';" class="btn">Centro Deportivo B</button></li>
				</ul>
				<ul>
			...
			<form action="book.php" method="POST">
				...
				<p class="radio-box">
					<Label class="label-container">Fulbito
						<input checked="checked" name="item" type="radio" value="5" />
						<span class="checkmark"></span>
					</Label>
					<Label class="label-container">Basket
						<input name="item" type="radio" value="6" />
						<span class="checkmark"></span>
					</Label>
					<Label class="label-container">Baseball
						<input name="item" type="radio" value="7" />
						<span class="checkmark"></span>
					</Label>
					<Label class="label-container">Tennis
						<input name="item" type="radio" value="8" />
						<span class="checkmark"></span>
					</Label>
				</p>
	...
	function draw_calendar($month, $year)
	{
		...
		for ($list_day = 1; $list_day <= $days_in_month; $list_day++) :
			...
			$sql = "SELECT * FROM reservas_view WHERE $current_epoch BETWEEN start_day AND end_day AND id_ubicacion=8";
